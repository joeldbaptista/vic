...
/* Render the line-number gutter into dest[0..lnum_width-1].
...
/* Scan one source line through the colorizer and populate attrs[].
 * Returns the number of bytes scanned and updates *color_state. */
static int

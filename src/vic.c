...
dispatch_cmd(struct editor *g, int c, const struct cmd_ctx *ctx)
{
	...
	static const struct cmd_entry table[] = {
	    ...
	    {'j', motion_run_next_line_skip_ws_cmd, NULL},
	    {KEYCODE_DOWN, motion_run_next_line_skip_ws_cmd, NULL},
	    {ASCII_CR, motion_run_next_line_skip_ws_cmd, NULL},
	    {'k', motion_run_prev_line_skip_ws_cmd, NULL},
	    {KEYCODE_UP, motion_run_prev_line_skip_ws_cmd, NULL},
